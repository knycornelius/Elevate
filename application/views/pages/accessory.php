                            ...
                            <div class="col-md-4 col-md4">
                                <div class="col-md1 simpleCart_shelfItem">
                                    <a href="detail?category=e_accessory&id=<?php echo $accdata[$x]['id_item']; ?>">
                                        <img class="img-responsive" src="<?php echo base_url('assets/images/e_accessory/') . $accdata[$x]['image1'];
                                                                                    ?>" alt="" />
                                    </a>
                                    <h3><a href="detail?category=e_accessory&id=<?php echo $accdata[$x]['id_item'] ?>"><?= $accdata[$x]['item_name']; ?></a></h3>
                                    <div class="price">
