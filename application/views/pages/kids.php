                    ...
                    for ($i = 0; $i < 4; $i++) { ?>
                        <div class="product-go">
                            <div class=" fashion-grid">
                                <a href="detail?category=e_kids&id=<?php echo $kidsdata[$x]['id_item']; ?>"><img class="img-responsive " src="<?= base_url('assets/images/e_kids/') . $kidsdata[$x]['image1']; ?>" alt=""></a>
                            </div>
                            <div class=" fashion-grid1">
                                <h6 class="best2"><a href="detail?category=e_kids&id=<?php echo $kidsdata[$x]['id_item']; ?>"><?= $kidsdata[$x]['item_name']; ?> </a></h6>
                                <span class=" price-in1"> <?= "Rp." . number_format($kidsdata[$x]['price'], 0, ",", "."); ?></span>
                            </div>
                            <div class="clearfix"> </div>
                        </div>
                    <?php $x++;
